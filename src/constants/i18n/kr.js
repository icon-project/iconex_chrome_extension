export default {
  ...
  mainPageImportWalletDesc: '지갑 백업 파일(Keystore 파일) 또는 개인 키를 입력한 후에 사용할 수 있습니다.',
  ...
  transferPageLabel7: '가스 한도',
  transferPageLabel8: '데이터',
  transferPageLabel9: '(선택)',
  transferPageLabel10: '가스 가격',
  ...
  transferPagePlaceholder5: '가스 한도 입력',
  transferPageAllCheckBtn: '전액',
  transferPageAndCoin: '& 토큰 ',
  transferPageSlow: '느림',
  transferPageFast: '빠름',

  transferPageHelperTitle1: 'Transaction 실행 시 발생할 수 있는 최대 수수료는 가스 한도와 가스 가격을 곱한 값입니다.',
  transferPageHelperDesc1: 'Transaction이 발생했지만 채굴자에 의해 채택되지 않는 경우, 이미 사용된 수수료는 소진되고 해당 Transaction은 취소되니 적절한 수준의 가스 한도와 가스 가격을 설정해야 합니다.',
  transferPageHelperTitle2: '가스 한도는 Transaction 실행에 지불할 용의가 있는 가스의 최대량을 의미합니다.',
  transferPageHelperDesc2: '가스 한도를 더 높게 설정하더라도 Transaction에 필요한 만큼의 가스만 소진합니다.\n즉, 가스한도는 최대치만 설정 가능하며 실제 소진되는 가스량은 유동적입니다.',
  transferPageHelperTitle3: '가스 가격은 단위가 1 Gwei = 0.000000001 ETH로 고정되어 있습니다.',
  transferPageHelperDesc3: '이더리움 채굴자는 블록을 생성할 때 자신에게 가장 이익이 되는 Transaction을 먼저\n채택합니다. 이는 가스 가격을 높게 설정할수록, 또는 가스 한도가 높을수록 채택될 확률이\n높음을 의미하며, 따라서 전송속도에 영향을 미치게 됩니다',
  transferPageHelperTitle4: '수신자로부터 Data 입력을 요청 받지 않은 경우에는 입력하지 않고 송금할 수 있습니다.',
  transferPageHelperDesc4: 'Data를 입력해야만 거래가 실행되도록 설계되어 있는 경우, Data를 입력하지 않으면\n송금이 불가하며 수수료만 차감될 수 있습니다.',
  ...
  deleteWallet: {
    info1: '지갑을 삭제하시겠습니까?',
    info2: '삭제하시려는 지갑에 잔액이 남아 있습니다.<br/>백업 여부를 확인하십시오.<br/>그래도 삭제하시겠습니까?',
  },
  ...
  swapToken: {
    ...
    cancelWalletAndSwap: '지갑 만들기를 취소하시겠습니까?',
    cancelSwap: '토큰 스왑을 취소하시겠습니까?',

    leftInfoTitle1_1: '현재 토큰 스왑용 ICX 지갑 만들기 단계까지만 지원합니다.',
    leftInfoDesc1_1: '· 추후 스왑 기능이 활성화 되면, 만들어 둔 스왑용 지갑으로 나머지 절차를 완료할 수 있습니다.',
    rightHeaderDesc1: '안내를 읽고 지갑을 만들어주세요.',

    rightInfoTitle1_1: '토큰 스왑용 ICX 지갑 생성',
    rightInfoDesc1_1_1: '· 안내에 따라 진행하시면 토큰 스왑용 ICX 지갑이 새로 만들어집니다. (스왑용 지갑의 개인 키는 기존 이더리움 지갑의 개인 키와 동일)',
    rightInfoDesc1_1_2: '· 지갑의 이름은 토큰 스왑을 위해 생성한 지갑임을 명확하게 알 수 있도록 설정해 주세요.',

    rightInfoTitle1_3: '마이이더월렛 또는 거래소 지갑에 토큰 보유 시',
    rightInfoDesc1_3_1: '· 마이이더월렛 등 개인지갑에 토큰을 보유하신 경우, 아래 안내를 따라 진행해주세요.',
    ...
    checkInfo: '안내를 읽었으며, 지갑 만들기를 진행합니다.',
    ...
    // leftInfoTitle5_1: '개인 키는 지갑을 직접 실행할 수 있는 고유 정보입니다. 프린트하거나 적어 두고 보관할 수 있습니다.',
    // leftInfoDesc5_1: '· 개인 키만 보유하면 지갑 실행 및 송금이 가능하니, 누구에게도 노출되지 않도록 각별한 관리가 필요합니다.',
    // leftInfoDesc5_2: '· 지금 즉시 복사 또는 프린트하지 않더라도 ‘지갑 백업’ 메뉴를 선택해 다시 진행할 수 있습니다.',
    // rightHeaderDesc5: '종이 지갑을 프린트하거나 개인 키를 적어두세요.',
    ...
    swapQuantity: '스왑할 코인 수량',
    inputPlaceholder: '코인 수량 입력',
    allCheckBtn: '전액',
    gasLimit: '적정 가스 한도',
    gasPrice: '적정 가스 가격',
    ...
    erc20AddressLabel: 'ERC20 토큰 컨트랙트 주소',
    erc20AddressInfo1: '· ICON의 ERC20 토큰 스왑 전용 컨트랙트 주소이며, 자동으로 입력됩니다.',
    erc20AddressInfo2: '· ICON 공식 채널에 해당 컨트랙트 주소가 안내되어 있으니, 안전을 위해 입력된 컨트랙트 주소가 정확한지 대조해 주시길 바랍니다.',
    icxAddressLabel: 'ICX 코인 받는 주소',
    icxAddressInfo1: '· 새로 생성된 ICX 지갑의 주소입니다.',
    icxAddressInfo2: '· 토큰 스왑 컨트랙트 주소에 스왑할 토큰을 송금한 후, ICX 코인 받는 주소로 ICX가 정해진 시각에 자동 지급됩니다.',

    swapInfoTitle: '토큰 스왑 안내',
