      ...
      if (_onlyPwGroup) {
        ...
        return (
          <div className={`pw-group ${style}`}>
            ...
            <input onChange={this.changeInput} onBlur={this.validateForm} onKeyPress={this.handleKeyPress} type={togglePw === 'on' ? 'text' : 'password'} className={`txt-type-normal ${pwError && 'error'}`} name="pw" placeholder={I18n.validationForm.inputPlaceHolder1} value={pw} />
            ...
            <input onChange={this.changeInput} onBlur={this.validateForm} onKeyPress={this.handleKeyPress} type={togglePwConfirm === 'on' ? 'text' : 'password'} className={`txt-type-normal gap ${pwConfirmError && 'error'}`} name="pwConfirm" placeholder={I18n.validationForm.inputPlaceHolder2} value={pwConfirm} />
              ...
              <div className={`${pwDivClass} tabbox-holder`}>
                { isWalletNameFormExist && (
                  <div className="name-group">
                    ...
                    <input onChange={this.changeInput} onBlur={this.validateForm} onKeyPress={this.handleKeyPress} name="walletName" type="text" className={`txt-type-normal ${walletNameError && 'error'}`} placeholder={I18n.validationForm.walletNamePlaceHolder} value={walletName} spellCheck="false"/>
