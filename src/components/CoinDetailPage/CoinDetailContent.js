...
import { LoadingComponent, QrcodeComponent, CurrencyMenuBar, TransactionHistory, CopyButton, Alert } from 'components/'
...
import DEFAULT_ICON from 'image/icon/icon_default.png';
      ...
      <div>
        ...
        <div className="wrap-holder bg">
          ...
          { isToken && (<span onClick={this.handleDeleteToken} className="del-token"><em className="_img"></em>{I18n.button.removeToken}</span>) }
           {/*
            //   isToken && !data.balanceLoading && data.balance.eq(0) && (
            //     <span onClick={this.handleDeleteToken} className="del-token"><em className="_img"></em>토큰 삭제</span>
            //   )
          */}
        </div>
        <TransactionHistory
