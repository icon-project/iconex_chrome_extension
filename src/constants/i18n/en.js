export default {
  ...
  error: {
    ...
    alertWalletChecked: 'Please select the Wallet to transfer.',
  ...
  transferPageLabel7: 'Gas limit',
  transferPageLabel8: 'Data',
  transferPageLabel9: '(Optional)',
  transferPageLabel10: 'Gas Price',
  ...
  transferPagePlaceholder5: 'Enter Gas Limit',
  transferPageAllCheckBtn: 'MAX',
  transferPageAndCoin: '& Coin',
  transferPageSlow: 'Slow',
  transferPageFast: 'Fast',

  transferPageHelperTitle1: 'Estimated Maximum Fee = Gas price * Gas limit.',
  transferPageHelperDesc1: 'Set proper gas limit and gas price. You will pay transaction fees even if your transaction is not confirmed by miners.',
  transferPageHelperTitle2: "Gas limit is the amount of gas to send with your transaction.",
  transferPageHelperDesc2: 'Unnecessary gas is refunded to you at the end of transaction. In other words, you can set the maximum amount of gas but the actual gas consumption is not fixed.',
  transferPageHelperTitle3: 'Gas price is a unit of gas. 1 Gwei equals 0.000000001 ETH.',
  transferPageHelperDesc3: 'Ethereum miners prioritize based on gas price when generating blocks. If you set higher gas price, you have more chance to get your transaction confirmed. It also determines your transaction speed.',
  transferPageHelperTitle4: 'If you do not enter the data when required, the transaction will fail.',
  transferPageHelperDesc4: "You will still have to pay the transaction fees.You don't have to enter data if it is not required in the transaction.",
  ...
  deleteWallet: {
    ...
    info2: 'You still have balance in your wallet.<br/>Are you sure you want to delete?',
  },
  ...
  sendTransaction: {
    ...
    swapSuccess: 'Request for swap has been completed. ICX will be distributed accordingly.',
  ...
  swapToken: {
    ...
    cancelWalletAndSwap: 'Cancel creating wallet?',
    cancelSwap: 'Cancel token swap?',

    leftInfoTitle1_1: 'ICX ERC20 tokens on the Ethereum network can now be swapped and transferred to ICON’s Mainnet.',
    leftInfoDesc1_1: '· Token swap will take place after you have created a new ICX coin wallet.',
    rightHeaderDesc1: 'Please refer to the following instructions.',

    rightInfoTitle1_1: 'Create wallet for Token Swap',
    rightInfoDesc1_1_1: '· Follow the guide to create your ICX wallet for the token swap. (The wallet created for the token swap will have the same private key as this ICONex ETH wallet)',
    rightInfoDesc1_1_2: '· Please make sure that you name the wallet so that you will know it is for the Token Swap.',

    rightInfoTitle1_3: 'If you store the ICX in MEW or Exchanges',
    rightInfoDesc1_3_1: '· If you store the ICX in MEW, please follow the below instructions.',
    rightInfoDesc1_3_2: '[Manual] How to create ICONex ETH wallet (Download)',
    rightInfoDesc1_3_3: '· The ICX stored in exchanges will be swapped without any extra procedure. Please make sure you do not send the ICX stored in exchanges to ICONex for token swap purposes.',

    checkInfo: 'I have read the above and agree to continue with the token swap.',
    ...
    // leftInfoTitle5_1: 'Use your private key to load your wallet from other devices. You can print or write the private key to keep it safe.',
    // leftInfoDesc5_1: '· Pay special attention to your private key as anyone who can access to the private key can transfer assets from the wallets without your permission.',
    // leftInfoDesc5_2: '· You can print your private key from the "Backup wallet" menu later.',
    // rightHeaderDesc5: 'Print your paper wallet or write down your private key.',
    ...
    gasInfo: '· Gas limit and gas price is optimized for the token swap.',
    ...
    erc20AddressInfo2: '· Please refer to ICON’s official channel regarding the contract address as we recommend double checking the address.',
    ...
    swapInfoTitle: 'Token Swap Information',
