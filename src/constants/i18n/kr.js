export default {
  ...
  createWallet: {
    ...
    leftInfoDesc1_3: '· 코인 지갑 생성 후, 해당 코인 기반의 토큰을 추가하실 수 있습니다.',
    ...
    leftInfoDesc2_2: '· 모바일이나 다른 PC로 지갑을 옮기는 경우 지갑 백업 파일(Keystore 파일) 또는 개인 키와 함께 비밀번호를 입력해야 합니다.',
    ...
    leftInfoTitle3_1: '지갑 백업 파일(Keystore 파일)은 개인 키를 암호화하여 저장한 파일이며, 사용을 위해서는 지정한 지갑 비밀번호를 입력해야 합니다.',
    leftInfoDesc3_1: '· 지갑이 삭제된 경우나 다른 PC 사용 시, Keystore 파일을 이용하여 지갑을 실행할 수 있습니다.',
    leftInfoDesc3_2: '· 지갑 백업 파일(Keystore 파일)은 비밀번호만 알면 지갑을 실행할 수 있는 중요한 정보이므로, 다른 사람에게 노출되지 않도록 안전하게 보관해야 합니다.',
    ...
    leftInfoDesc4_1: '· 지갑이 삭제된 경우나 다른 PC 사용 시, 개인 키를 이용하여 지갑을 실행할 수 있습니다.',
    leftInfoDesc4_2: '· 개인 키만 보유하면 지갑 실행 및 송금이 가능하니, 누구에게도 노출되지 않도록 각별한 관리가 필요합니다.',
    leftInfoDesc4_3: '· 지금 즉시 복사 또는 프린트하지 않더라도 ‘지갑 백업’ 메뉴를 선택해 다시 진행할 수 있습니다.',
    privateKey: '개인 키',
  },
  ...
  backupWallet: {
    title: '지갑 백업',
    desc: "'지갑 백업 파일(Keystore 파일) 다운로드' 또는 '개인 키 저장'으로 백업을 진행할 수 있습니다.\nICONex를 안전하게 사용하기 위해서는 반드시 다양한 방식으로 개인 키를 백업하세요.",
    ...
    infoBoxDesc2_1: '· 개인 키가 삭제되거나 타인에게 노출되지 않도록 안전하게 보관해 주세요.',
    infoBoxDesc2_2: '· 종이 지갑을 프린트하거나, 분실할 위험이 없는 메모장 등에 별도로 안전하게 복사해 두세요.',
  },
